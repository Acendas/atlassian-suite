...
6. **Render output.** Markdown by default. Offer Confluence wiki markup as an alternate format if the user mentions Confluence (and offer to call `/atlassian-suite:as-publish-release-notes` to push it).
